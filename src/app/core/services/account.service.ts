...
export class AccountService {
  ...
  getAccounts(param: ParamSearch): Observable<any> {
    ...
    params = params.append(
      'last_name',
      param.last_name ? param.last_name.toString() : ''
    );
    params = params.append(
      'first_name',
      param.first_name ? param.first_name.toString() : ''
    );
    params = params.append(
      'gender',
      param.gender ? param.gender.toString() : ''
    );
    params = params.append('email', param.email ? param.email.toString() : '');
    params = params.append(
      'address',
      param.address ? param.address.toString() : ''
    );
  ...
  editAccount(acc: Account, id: string): Observable<any> {
